...
// 读第一个帧 - (参考帧)
// 返回值: 0-出错; 1-正确
int ReadAMRFrameFirstData(const char* fpamr,int pos,int maxLen, unsigned char frameBuffer[], int* stdFrameSize, unsigned char* stdFrameHeader)
{
    int nPos = 0;
...
// 返回值: 0-出错; 1-正确
int ReadAMRFrameData(const char* fpamr,int pos,int maxLen, unsigned char *frameBuffer, int stdFrameSize, unsigned char stdFrameHeader)
{
//	int bytes = 0;
    int nPos = 0;
